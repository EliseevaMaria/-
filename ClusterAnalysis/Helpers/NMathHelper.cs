...
namespace ClusterAnalysis.Helpers
{
    public class NMathHelper
    {
        ...
        private string[] LinkageFunctions => this.linkageFunctions ??
            (this.linkageFunctions = new string[] { "Single linkage function", "Complete weighted linkage function", "Median linkage function" });
        ...
        public NMathHelper(CountryStatistics[] countryStatistics)
        {
            ...
            {
                dataMatrix[i, 0] = countryStatistics[i].AlcoholConsumption;
                dataMatrix[i, 1] = countryStatistics[i].FruitConsumption;
